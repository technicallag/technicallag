...
class FixedPairAnalysisTests {
    ...
    private fun getResults(aID: Int, bID: Int, pm: PackageManager) : PairStatistics {
        val results = FixedPairAnalysis.classifyPair(CollectDataForPair.collectDataForFixedAnalysis(PairIDs(aID,bID)), pm)
        results.printToFile("data/pairwiseResults/errors/${pm}_${aID}_${bID}_latest.csv")
        return results
    }

    private fun getResultsBackwardsChanges(aID: Int, bID: Int, pm: PackageManager) : PairStatistics {
        val results = FixedPairAnalysis.classifyPair(CollectDataForPair.collectDataForFixedAnalysis(PairIDs(aID,bID)), pm)
        results.printToFile("data/pairwiseResults/backwards/errors/${pm}_${aID}_${bID}_latest.csv")
        return results
    }

    private fun getRawData(aID: Int, bID: Int, pm: PackageManager) : PairFullDataFixed {
        val rawData = CollectDataForPair.collectDataForFixedAnalysis(PairIDs(aID,bID))
        val results = FixedPairAnalysis.classifyPair(rawData, pm)
        results.printToFile("data/pairwiseResults/errors/${pm}_${aID}_${bID}_latest.csv")
        return rawData
    }
    ...
    fun backwardsTestPubTimeTooClose_1157630_921() {
        ...
        val results = getResultsBackwardsChanges(1157630, 921, PackageManager.HEX)
    ...
    fun backwardsTestSimultaneousDevelopmentProblem_930779_930773() {
        ...
        val results = getResultsBackwardsChanges(930779, 930773, PackageManager.ATOM)
    ...
    fun backwardsTestTagOrderingProblem_1777583_1643839() {
        ...
        val results = getResultsBackwardsChanges(1777583, 1643839, PackageManager.ATOM)
        assertFalse(results.hasThisUpdate.contains(Update.BACKWARD_MICRO))
    }
    ...
    fun lagTest_263381_223861() {
        ...
        val results = getResults(263381, 223861, PackageManager.RUBYGEMS)
    ...
    fun lagCorrectWhenLatest_229043_239833() {
        ...
        val results = getResults(229043, 239833, PackageManager.RUBYGEMS)
    ...
    fun orderingTags_2427516_245694() {
        ...
        val results = getResults(2427516, 245694, PackageManager.RUBYGEMS)
    ...
    fun orderingTags_369494_651538() {
        ...
        val results = getRawData(369494, 651538, PackageManager.MAVEN)
    ...
    fun lagMissingVersions_372752_340080() {
        ...
        val results = getResults(372752, 340080, PackageManager.MAVEN)
